...
const availableValues = this.props.data;
...
class BudgetTable extends React.PureComponent {
  constructor(props) {
    super(props);
    ...
    //   ],
      rows: availableValues({
        columnValues: { id: ({ index }) => index, ...availableValues },
      ...
      pageSize: 0,
      pageSizes: [5, 10, 0],
      columnOrder: ['name', 'category', 'type', 'frequency', 'amount'],
...
export default withStyles(styles, { name: 'ControlledModeDemo' })(BudgetTable);
